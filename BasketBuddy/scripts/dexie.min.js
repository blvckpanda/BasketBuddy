(function (e, t) {
    ...
    .extend({
      stack: {
        get: function () {
          return (
            this._stack ||
            (this._stack = this.name + ": " + this.message + V(this._e, 2))
          );
        },
      },
      toString: function () {
      ...
      function t(e, t) {
        (this._e = U()),
          ...
          e
            ...
            : ((this.message = z[n] || r), (this.inner = null));
      }
      ...
      get: function () {
        ...
        try {
          ...
          var e = (function e(t, n, r) {
            ...
            F &&
              ((i = V(t._stackHolder, 2)) && -1 === n.indexOf(i) && n.push(i),
      ...
      try {
        return n && n.db === this.db
          ...
          : (function e(t, n, r, i) {
              if (
                t.idbdb &&
                (t._state.openComplete || Oe.letThrough || t._vip)
              ) {
              ...
              if (t._state.openComplete)
                return lt(new J.DatabaseClosed(t._state.dbOpenError));
  ...
  function It(e, o, t, n) {
    ...
    if (e.or) {
      ...
      return Promise.all([
        e.or._iterate(r, t),
        Tt(Bt(e, n, t), e.algorithm, r, !e.keysOnly && e.valueMapper),
      ]);
    }
        ...
        return n
          ...
          .then(function (f) {
            ...
            return h(0).then(function () {
              if (0 < u.length)
                throw new H("Error modifying one or more objects", u, s, t);
              return f.length;
            });
          });
      });
      ...
      .race([
        ...
        ("undefined" == typeof navigator
          ...
          return new je(function (s, n) {
            ...
            (l.onerror = Jt(n)),
              (l.onblocked = Le(f._fireOnBlocked)),
              (l.onupgradeneeded = Le(function (e) {
                var t;
                (d = l.transaction),
              ...
              (l.onsuccess = Le(function () {
                ...
                yt.push(f),
                  (o.onversionchange = Le(function (e) {
  ...
  function Vn(e, t) {
    ...
    if (r.done) return !1;
    for (
      var i = r.value, o = Wn(e), a = o.next(i.from), u = a.value;
      !r.done && !a.done;
